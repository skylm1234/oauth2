...
public class L30RefreshStoreImpl implements Process<CommRefreshStoreRequestProtobuf.CommRefreshStoreRequest
	...
	@Override
	public CommRefreshStoreResponseProtobuf.CommRefreshStoreResponse doProcess(CommRefreshStoreRequestProtobuf.CommRefreshStoreRequest commRefreshStoreRequest) throws Exception {
		return null;
	}
}
